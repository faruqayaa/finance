...
class HomeScreen extends StatelessWidget {
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                  ...
                  child: ListView(
                    ...
                    children: const [
                      AtmCard(
                        ...
                        color2: Color(0xFFF7931E),
                      ),
                      AtmCard(
                        bankName: 'Bank BCA',
                        cardNumber: '**** 8765',
                        balance: 'Rp5.350.000.000',
                        color1: Color(0xFF1E73BE),
                        color2: Color(0xFFEAF2F8),
                      ),
                      AtmCard(
                      ...
                      AtmCard(
                        ...
                        color1: Color(0xFF006C54),
                        color2: Color(0xFF00A65A),
                      ),
                    ],
                  ),
                ),
                ...
                const SizedBox(height: 12),
                SizedBox(
                  height: 140, // tinggi container Grid Menu
                  child: ListView(
                    scrollDirection: Axis.horizontal,
                    children: [
                      _animatedMenuItem(Icons.health_and_safety, 'Health', Colors.pinkAccent, 0),
                      _animatedMenuItem(Icons.travel_explore, 'Travel', Colors.blueAccent, 1),
                      _animatedMenuItem(Icons.fastfood, 'Food', Colors.orangeAccent, 2),
                      _animatedMenuItem(Icons.event, 'Event', Colors.greenAccent, 3),
                    ],
                  ),
                ),
                const SizedBox(height: 24),
  ...
  // ===== Fungsi animasi horizontal Grid Menu =====
    ...
    return TweenAnimationBuilder(
      ...
      builder: (context, double scale, child) {
        return Transform.scale(
          scale: scale,
          child: Container(
            width: 140, // diperlebar agar menu lebih ke kanan
